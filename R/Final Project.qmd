...
The sauces dataset involves Hot Ones sauces that have been tried over the 21 seasons and their Scoville Heat Units.
...
#| echo: FALSE
#| label: tbl-two
#| tbl-cap: "This is a regression table for the sauces dataset"
...
#| echo: FALSE
#| label: tbl-three
#| tbl-cap: "This is a regression table produced from the sauces dataset"
...
#| echo: FALSE
#| label: tbl-four
#| tbl-cap: "This is a regression table of Model 1 and Model 2"
...
Initialize a project renv::init()

Track dependencies via a lockfile renv::snapshot()

source("renv/activate.R")

Restore an environment renv::restore()

Status of project library renv::status()
